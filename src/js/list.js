...
function updateLocalStorage(update, sort, display = true) {
...
function updateStatus(todos, index) {
  todos[index].completed = !(todos[index].completed);
  updateLocalStorage(true, false, false);
}

function addCheckboxChangeEventListeners(todos) {
